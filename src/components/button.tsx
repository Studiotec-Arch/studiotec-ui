...
/**
 * Escala conferida contra o uso real do produto: `h-8` (32px) e `h-7` (28px)
 * somam quase 200 chamadas no Portal RC, enquanto o `default` de 40px que o
 * shadcn traz não é usado nenhuma vez — todo mundo o sobrescrevia na chamada.
 * Por isso o padrão aqui é 32px.
 *
 * `default` é tinta (foreground), não verde: o verde da marca fica reservado
 * ao accent, ao foco e ao estado ativo. Para CTA no accent, use `primary`.
 */
